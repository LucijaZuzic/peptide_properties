...
if not os.path.exists("../final_no_all/"):
    os.makedirs("../final_no_all/")

# Write output to file
sys.stdout = open("../final_no_all/training_log.txt", "w", encoding="utf-8")

# Save model to correct file based on number of fold
model_file, model_picture = "../final_no_all/model.h5", "../final_no_all/model_picture.png"
...
other_output = open("../final_no_all/results_accuracy_loss.txt", "w", encoding="utf-8")
other_output.write(
...
other_output = open("../final_no_all/accuracy.txt", "w", encoding="utf-8")
other_output.write(str(accuracy))
other_output.write("\n")
other_output.close()

other_output = open("../final_no_all/loss.txt", "w", encoding="utf-8")
...
plt.savefig("../final_no_all/accuracy.png", bbox_inches="tight")
plt.close()
...
plt.xlabel("Epoch")
plt.legend(loc="upper center", bbox_to_anchor=(0.5, -0.1), ncol=2)
plt.savefig("../final_no_all/loss.png", bbox_inches="tight")
plt.close()
