...
PRthr = {MODEL_DATA_PATH: 0.320440828, SEQ_MODEL_DATA_PATH: 0.32140276000000007, MY_MODEL_DATA_PATH: 0.22412928599999998,
        TSNE_SEQ_DATA_PATH: 0.277013928, TSNE_AP_SEQ_DATA_PATH: 0.30854635999999996}
ROCthr = {MODEL_DATA_PATH: 0.6066449939999999, SEQ_MODEL_DATA_PATH: 0.6172134180000001, MY_MODEL_DATA_PATH: 0.526199318,
        TSNE_SEQ_DATA_PATH: 0.556881612, TSNE_AP_SEQ_DATA_PATH: 0.549448272}
...
def read_ROC(test_labels, model_predictions, lines_dict, old_PR_thr, old_ROC_thr): 
    ...
    lines_dict['gmean (PR thr old) = '].append(returnGMEAN(test_labels, model_predictions_binary_thrPR_new))
    lines_dict['gmean (ROC thr old) = '].append(returnGMEAN(test_labels, model_predictions_binary_thrROC_new))
    lines_dict['gmean (PR thr new) = '].append(returnGMEAN(test_labels, model_predictions_binary_thrPR_old))
    lines_dict['gmean (ROC thr new) = '].append(returnGMEAN(test_labels, model_predictions_binary_thrROC_old))
    #lines_dict['gmean new = '].append(gmeans[ix])  
    lines_dict['Accuracy (ROC thr old) = '].append(my_accuracy_calculate(test_labels, model_predictions, thresholds[ix])) 
    lines_dict['Accuracy (ROC thr new) = '].append(my_accuracy_calculate(test_labels, model_predictions, old_ROC_thr)) 
 
def read_PR(test_labels, model_predictions, lines_dict, old_PR_thr, old_ROC_thr): 
    # Get recall and precision.
    ...
    lines_dict['F1 (PR thr old) = '].append(f1_score(test_labels, model_predictions_binary_thrPR_new))
    lines_dict['F1 (ROC thr old) = '].append(f1_score(test_labels, model_predictions_binary_thrROC_new))
    lines_dict['F1 (PR thr new) = '].append(f1_score(test_labels, model_predictions_binary_thrPR_old))
    lines_dict['F1 (ROC thr new) = '].append(f1_score(test_labels, model_predictions_binary_thrROC_old))
    lines_dict['Accuracy (PR thr old) = '].append(my_accuracy_calculate(test_labels, model_predictions, thresholds[ix]))
    lines_dict['Accuracy (PR thr new) = '].append(my_accuracy_calculate(test_labels, model_predictions, old_PR_thr))
