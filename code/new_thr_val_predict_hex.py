...
PRthr = {'../final_all/hex_predict.txt': 0.320440828, '../final_seq/hex_predict.txt': 0.32140276000000007, '../final_AP/hex_predict.txt': 0.22412928599999998,
        "../final_TSNE_seq/hex_predict.txt": 0.277013928, "../final_TSNE_AP_seq/hex_predict.txt": 0.30854635999999996}
ROCthr = {'../final_all/hex_predict.txt': 0.6066449939999999, '../final_seq/hex_predict.txt': 0.6172134180000001, '../final_AP/hex_predict.txt': 0.526199318,
        "../final_TSNE_seq/hex_predict.txt": 0.556881612, "../final_TSNE_AP_seq/hex_predict.txt": 0.549448272}
