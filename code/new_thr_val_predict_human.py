...
PRthr = {'../final_no_human_all/human_AI_predict.txt': 0.37450, '../final_no_human_seq/human_AI_predict.txt': 0.40009, '../final_no_human_AP/human_AI_predict.txt': 0.44563,
        "../final_no_human_TSNE_seq/human_AI_predict.txt": 0.41442, "../final_no_human_TSNE_AP_seq/human_AI_predict.txt": 0.48019}
ROCthr = {'../final_no_human_all/human_AI_predict.txt': 0.74304, '../final_no_human_seq/human_AI_predict.txt': 0.66199, '../final_no_human_AP/human_AI_predict.txt': 0.68748,
        "../final_no_human_TSNE_seq/human_AI_predict.txt": 0.65300, "../final_no_human_TSNE_AP_seq/human_AI_predict.txt": 0.67038}

PRthr = {'../final_no_human_all/human_AI_predict.txt': 0.320440828, '../final_no_human_seq/human_AI_predict.txt': 0.32140276000000007, '../final_no_human_AP/human_AI_predict.txt': 0.22412928599999998,
        "../final_no_human_TSNE_seq/human_AI_predict.txt": 0.277013928, "../final_no_human_TSNE_AP_seq/human_AI_predict.txt": 0.30854635999999996}
ROCthr = {'../final_no_human_all/human_AI_predict.txt': 0.6066449939999999, '../final_no_human_seq/human_AI_predict.txt': 0.6172134180000001, '../final_no_human_AP/human_AI_predict.txt': 0.526199318,
        "../final_no_human_TSNE_seq/human_AI_predict.txt": 0.556881612, "../final_no_human_TSNE_AP_seq/human_AI_predict.txt": 0.549448272}
...
paths = ["../final_no_human_AP/human_AI_predict.txt", "../final_no_human_seq/human_AI_predict.txt", "../final_no_human_all/human_AI_predict.txt", 
        "../final_no_human_TSNE_seq/human_AI_predict.txt", "../final_no_human_TSNE_AP_seq/human_AI_predict.txt"] 
...
for some_path in paths: 
    ...
    print(test_labels, model_predictions_human_AI_one)
...
save_ress = open(DATA_PATH + "final_no_human_class_human_final.csv", "w")
