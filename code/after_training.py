...
import numpy as np
import pandas as pd  
from automate_training import load_data_SA, merge_data, merge_data_seq, load_data_SA_seq, merge_data_AP, load_data_SA_AP
from automate_training import reshape, reshape_seq, reshape_AP
