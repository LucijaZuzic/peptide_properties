...
'''
other_output = open(
    "../final_no_all/human_AI_predict.txt",
    "r",
    encoding="utf-8",
) 
...
other_output = open(
    "../final_no_AP/human_AI_predict.txt",
    "r",
    encoding="utf-8",
)
...
other_output = open(
    "../final_no_seq/human_AI_predict.txt",
    "r",
    encoding="utf-8",
)
...
best_model_file, best_model_image  = "../final_no_seq/model.h5", "../final_no_seq/model_picture.png"
...
best_model_file, best_model_image  = "../final_no_TSNE_seq/model.h5", "../final_no_TSNE_seq/model_picture.png"
...
other_output = open(
    "../final_no_TSNE_seq/human_AI_predict.txt",
    "w",
    encoding="utf-8",
)
...
best_model_file, best_model_image  = "../final_no_TSNE_AP_seq/model.h5", "../final_no_TSNE_AP_seq/model_picture.png"
...
other_output = open(
    "../final_no_TSNE_AP_seq/human_AI_predict.txt",
    "w",
    encoding="utf-8",
)
...
plt.savefig("../final_no_seq/human_AI_predict.png", bbox_inches="tight")
plt.close() 
 
best_model_file, best_model_image  = "../final_no_AP/model.h5", "../final_no_AP/model_picture.png" 
...
plt.savefig("../final_no_AP/human_AI_predict.png", bbox_inches="tight")
plt.close() 
 
best_model_file, best_model_image  = "../final_no_all/model.h5", "../final_no_all/model_picture.png" 
...
plt.savefig("../final_no_all/human_AI_predict.png", bbox_inches="tight")
plt.close() 
...
plt.savefig("../final_no_TSNE_seq/human_AI_predict.png", bbox_inches="tight")
plt.close() 
...
plt.savefig("../final_no_TSNE_AP_seq/human_AI_predict.png", bbox_inches="tight")
plt.close() 
